...
namespace ObjectComparer.Tests.Tests
{
    ...
    {
        private const string TYPE_NAME = "dynamic";
        [Test]
        ...
        public void Test_NullableStartsWithNull()
        {
            ...
            // Act
            copy.TestDynamicNullable = "Hello World";

            // Assert
            TestContext.Out.WriteLine("copy {0}?: {1}", TYPE_NAME, copy.TestDynamicNullable?.ToString() ?? "<NULL>");
            TestContext.Out.WriteLine("model {0}?: {1}", TYPE_NAME, model.TestDynamicNullable?.ToString() ?? "<NULL>");
        ...
        public void Test_NullableStartsNotWithNull()
        {
            ...
            TestModel model = new TestModel
            {
                TestDynamicNullable = "Hello World"
            };
            ...
            // Act
            copy.TestDynamicNullable = "Goodbye World";
